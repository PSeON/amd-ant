...
test('Anonymous circular', async () => {
  const modules = {
    'funcFour.js'() {
      window.define(['require', 'funcThree'], require => {
    ...
    'funcOne.js'() {
      window.define(['require', 'funcTwo'], require => {
    ...
    'funcThree.js'() {
      window.define(['require', 'funcFour'], (require, four) => {
    ...
    'funcTwo.js'() {
      window.define(['require', 'funcOne'], require => {
    ...
    'one.js'() {
      window.define(['require', 'exports', 'module', 'two'], (require, exports, module) => {
        exports.size = 'large';
    ...
    'two.js'() {
      window.define(['require', 'one'], (require, one) => ({
        size: 'small',
        color: 'redtwo',
